    ...
    <View style={styles.container}>
      {/* Header with back arrow and progress bar */}
          ...
          <View style={styles.optionsContainer}>
            {GENDER_OPTIONS.map((option) => (
              <TouchableOpacity
                ...
                style={[
                  styles.styleChip,
                  data.gender === option && styles.styleChipSelected,
                ]}
              ...
              >
                <Text
                  style={[
                    ...
                    data.gender === option && styles.styleChipTextSelected,
                  ]}
                >
                  {option}
                </Text>
        ...
        <View style={[styles.bottomBar, { paddingBottom: insets.bottom + 12 }]}>
          <TouchableOpacity
            style={[styles.continueButton, !data.gender && styles.continueButtonDisabled]}
